    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gradient-to-br from-dark-50 dark:from-dark-800 to-primary-50 dark:to-dark-700 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-dark-500 dark:text-dark-400 mt-1 text-sm">Welcome back! Sign in to your account</p>
        </div>
        ...
        <div className="card !p-8">
          ...
          <p className="text-center text-sm text-dark-500 dark:text-dark-400 mt-6">
            ...
            <Link to="/student/register" className="text-primary-600 dark:text-primary-400 font-semibold hover:text-primary-700 dark:hover:text-primary-300">Register here</Link>
          </p>
          <p className="text-center text-sm text-dark-400 dark:text-dark-500 mt-2">
            Are you a supervisor?{' '}
            <Link to="/supervisor/login" className="text-primary-600 dark:text-primary-400 font-medium hover:text-primary-700 dark:hover:text-primary-300">Login here</Link>
          </p>
        </div>
      </div>
    </div>
