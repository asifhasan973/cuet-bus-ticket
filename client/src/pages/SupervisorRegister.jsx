    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center bg-gradient-to-br from-dark-50 dark:from-dark-800 to-accent-50 dark:to-dark-700 p-4 py-8">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-dark-900 dark:text-white">Supervisor Registration</h1>
        ...
        <div className="card !p-8">
          ...
          <p className="text-center text-sm text-dark-500 dark:text-dark-400 mt-6">
            ...
            <Link to="/supervisor/login" className="text-accent-600 dark:text-accent-400 font-semibold hover:text-accent-700 dark:hover:text-accent-300">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
