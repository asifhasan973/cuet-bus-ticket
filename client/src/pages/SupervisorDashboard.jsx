    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-dark-500 dark:text-dark-400 text-sm mt-1">
          Manage attendance and bus operations
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <StatsCard
          ...
          value={buses.reduce((s, b) => s + b.totalSeats, 0)}
          color="warning"
        />
        <StatsCard
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-dark-100 dark:border-dark-600">
                  <th className="text-left py-2 px-3 text-xs font-bold text-dark-500 dark:text-dark-400 uppercase">
                    Shift
                  </th>
                  <th className="text-left py-2 px-3 text-xs font-bold text-dark-500 dark:text-dark-400 uppercase">
                    Weekday
              ...
              <tbody>
                {SHIFT_SCHEDULE.map((s) => (
                  ...
                  >
                    ...
                    <td className="py-2.5 px-3 font-semibold text-dark-700 dark:text-dark-200">
                      {s.weekday}
                    </td>
                    <td className="py-2.5 px-3 font-semibold text-dark-500 dark:text-dark-400">
                      {s.weekend}
                    </td>
      ...
      <div className="card !p-0 overflow-hidden">
        ...
        <div className="divide-y divide-dark-100 dark:divide-dark-600">
          {buses.map((bus) => (
            <div
              key={bus._id}
              className="px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 hover:bg-dark-50 dark:hover:bg-dark-600/20 transition-colors"
            >
